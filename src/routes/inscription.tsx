    ...
    <div className="relative grid min-h-dvh place-items-center px-4 pt-28">
      ...
      <div className="w-full max-w-md rounded-3xl border border-glass-border bg-glass p-8">
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <input type="text" placeholder="Nom d'affichage" aria-label="Nom" className="h-11 w-full rounded-xl border border-glass-border bg-background/40 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
          ...
          <button type="submit" className="inline-flex h-11 w-full items-center justify-center rounded-full bg-gradient-brand text-sm font-semibold text-white">
            Créer mon compte
          </button>
        </form>
