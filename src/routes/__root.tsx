...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Lumière — Streaming premium pour créateurs et cinéphiles" },
      { name: "twitter:description", content: "Films, séries et animation portés par des créateurs indépendants. Découvrez une nouvelle façon de regarder." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/13effe79-45e0-47aa-98e4-3b5c44d6c832" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/13effe79-45e0-47aa-98e4-3b5c44d6c832" },
    ],
    links: [
      {
        rel: "stylesheet",
